...
for i in range(1, 6):
    ...
    trainEpi, val, test, _ = process_MITECG(split_no = i, device = device, hard_split = True, base_path = '/n/data1/hms/dbmi/zitnik/lab/users/owq978/TimeSeriesCBM/datasets/MITECG-Hard/')
