...
'''
Experiment 7 - Vary r parameter in GSAT loss
'''
gsat_weight = 1.0
connect_weight = 2.0
print('Running variation gsat_w = {:.2f} c_w = {:.2f}'.format(gsat_weight, connect_weight))

tencoder_path = "/n/data1/hms/dbmi/zitnik/lab/users/owq978/TimeSeriesCBM/experiments/scs_inline/models/Scomb_transformer_split={}.pt"
...
sim_criterion = EmbedConsistencyLoss(normalize_distance = True)

targs = transformer_default_args

for i in range(1, 6):
    D = process_Synth(split_no = i, device = device, base_path = '/n/data1/hms/dbmi/zitnik/lab/users/owq978/TimeSeriesCBM/datasets/SeqCombSingleInline')
    ...
    spath = 'models/v6_exp_noconcept_split={}.pt'.format(gsat_weight,connect_weight,i)
