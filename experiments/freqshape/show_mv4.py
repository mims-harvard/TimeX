...
from txai.vis.visualize_mv4 import visualize
from txai.models.modelv4 import Modelv4
...
def main():
    ...
    visualize(model, test, show = False, class_num = 1)
    fig = plt.gcf()
