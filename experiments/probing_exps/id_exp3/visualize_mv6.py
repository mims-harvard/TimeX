...
def visualize_explanations(model, test_tup, test_X_regular, n = 3, class_num = None, show = True, heatmap = True, topk = None, seed = None):
    '''
    TODO: Rewrite
    ...
    model.eval()
    with torch.no_grad():
        out = model(test_X_regular[:,inds,:], samp_times, src_id = sampX, captum_input = False)
