...
tencoder_path = "/n/data1/hms/dbmi/zitnik/lab/users/owq978/TimeSeriesCBM/experiments/probing_exps/id_exp/models/transformer_split={}.pt"
...
for i in range(1, 6):
    ...
    spath = 'models/ours_split={}.pt'.format(i)
