...
from txai.models.modelv5 import Modelv5Univariate, transformer_default_args, Modelv5Univariate_Window
...
for i in range(1, 6):
    ...
    model = Modelv5Univariate_Window(
        d_inp = 1,
        max_len = 50,
        n_classes = 4,
    ...
    spath = 'models/v5_w_split={}.pt'.format(i)
