...
'''
Experiment 13 - Try side matching of concepts
'''
gsat_weight = 1.0
connect_weight = 2.0
...
for i in range(1, 6):
    ...
    abl_params = AblationParameters(equal_g_gt = False, trend_smoother_loss = False, concept_matching = False,
        hard_concept_matching = hard_selection, use_loss_on_concept_sims = score_div_loss,
        use_concept_corr_loss = False, side_concept_matching = True)
    ...
    spath = 'models/v6_exp13_split={}.pt'.format(
        i
    )
