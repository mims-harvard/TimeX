...
'''
Experiment 4 - 3 and 4 branches of explainers
'''
n_branches = 4
print('Running variation = {} branches'.format(n_branches))
...
for i in range(1, 6):
    ...
    spath = 'models/v6_exp4_{}branch_split={}.pt'.format(n_branches, i)
