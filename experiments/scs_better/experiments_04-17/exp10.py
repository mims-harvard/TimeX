...
'''
Experiment 10 - Try concept selection with hard and soft strategies
'''
gsat_weight = 1.0
connect_weight = 2.0
...
score_div_loss = True
conc_corr_loss = True
print('Running variation {} with score div loss {} with conc corr loss {}'.format('hard' if hard_selection else 'soft', score_div_loss, conc_corr_loss))
...
for i in range(1, 6):
    ...
    abl_params = AblationParameters(equal_g_gt = False, trend_smoother_loss = False, concept_matching = True,
        ...
        use_concept_corr_loss = conc_corr_loss)
    ...
    spath = 'models/v6_exp10_hard={}_kld={}_ccl={}_negdiv_split={}_NEW.pt'.format(hard_selection,score_div_loss,conc_corr_loss,i)
