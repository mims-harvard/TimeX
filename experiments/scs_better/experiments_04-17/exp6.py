...
from txai.utils.predictors.loss_cl import SimCLRLoss, ConceptTopologyLoss, GeneralScoreContrastiveLoss, SimCLRwConsistencyLoss
...
'''
Experiment 2 - Optimize smoother vs. no smoother optimization
'''
print('Running variation = simclr and consistency')
...
sim_criterion = SimCLRwConsistencyLoss(lam = 2.0)
...
for i in range(1, 6):
    ...
    model = Modelv6_v2(
        ...
        trend_smoother = True, # Use it, but experiment with not optimizing it
    ...
    spath = 'models/v6_exp6_scwcon_split={}.pt'.format(i)
