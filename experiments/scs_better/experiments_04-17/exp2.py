...
'''
smoother = False
print('Running variation = {}'.format(smoother))
...
for i in range(1, 6):
    ...
    abl_params = AblationParameters(equal_g_gt = True, trend_smoother_loss = smoother)
    ...
    spath = 'models/v6_exp2_s={}_split={}.pt'.format(1 if smoother else 0,i)
