...
'''
Experiment 9 - Try concept selection, vary the number of concepts used
'''
gsat_weight = 1.0
connect_weight = 2.0
nconcepts = 3
print('Running variation n concepts = {}'.format(nconcepts))
...
for i in range(1, 6):
    ...
    spath = 'models/v6_exp9_nc={}_split={}.pt'.format(nconcepts,i)
