...
from txai.utils.predictors.loss_cl import SimCLRLoss, ConceptTopologyLoss, GeneralScoreContrastiveLoss, ConceptConsistencyLoss, LabelConsistencyLoss
...
for i in range(1, 6):
    ...
    abl_params = AblationParametersPrototype(
        ...
        min_max_loss_ptype_scores = False,
    ...
    spath = 'models/trial_split={}_uniscorenet.pt'.format(i)
