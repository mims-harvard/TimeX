...
def main(model, test, class_num, heatmap = False, seed = None, topk = None):
    ...
    np.random.seed(seed)
    visualize_explanations(model, test, show = False, class_num = class_num, heatmap = heatmap, topk = topk)
    fig = plt.gcf()
...
if __name__ == '__main__':
    ...
    main(model, test, args.class_num, heatmap = args.heatmap, seed = args.sample_seed, topk = args.topk)
