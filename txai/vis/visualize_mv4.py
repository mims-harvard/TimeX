...
def visualize(model, test_tup, n = 3, per_class = False, class_num = None, show = True, sim = False, v5 = False):
    ...
    pred, pred_mask, pred_mask_tilde = out['all_preds']
    mask = out['ste_mask']
    ...
    pred_mask_tilde = pred_mask_tilde.softmax(dim=1).argmax(dim=1)
