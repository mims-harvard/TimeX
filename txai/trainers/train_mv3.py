...
def train_mv3(
    ...
    for epoch in range(num_epochs):
        ...
        for X, times, y in train_loader:
            ...
            out, out_tilde, masks, ste_mask, smoother_stats, smooth_src = model(X, times, captum_input = True)
            ...
            loss = clf_loss + exp_loss + logit_loss
            ...
            cum_logit_loss.append(logit_loss.detach().item())
        ...
        f1, (pred, pred_tilde, masks, ste_mask, smoother_stats, smooth_src) = eval_mv3(val_tuple, model)
        ...
        logit_loss = beta_logit * logit_criterion(F.log_softmax(pred, dim=-1), F.softmax(pred_tilde, dim=-1))
