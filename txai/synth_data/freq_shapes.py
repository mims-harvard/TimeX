...
class FreqShapes(GenerateSynth):
    ...
    def generate_seq(self, class_num = 0):
        ...
        start = np.random.choice(np.arange(freq))
...
if __name__ == '__main__':
    ...
    for i in range(1):
        train, val, test, gt_exps = gen.get_all_loaders(Ntrain=50, Nval=1, Ntest=10)
        ...
        #torch.save(dataset, '../../datasets/FreqShape/split={}.pt'.format(i + 1))
